...
df = pd.read_xml(f"data\items.xml", parser="lxml", xpath=".//artikel")
...
with open(r'data\producers.sql', "w", encoding='utf8') as f:
...
with open(r'data\suppliers.sql', "w", encoding='utf8') as f:
